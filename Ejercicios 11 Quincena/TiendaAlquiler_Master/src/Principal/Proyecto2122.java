...
public class Proyecto2122 {
    ...
    public static void main(String[] args) {
        ...
        ListaAlquileres misAlquileres = new ListaAlquileres();
        Autor autorObj;
        Cliente cli;
        Alquiler alq;
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 6:
                    ...
                    cli = misClientes.buscaCliente(dni);
                    System.out.print("Código Artículo: ");
                    cod = consola.nextLine();
                    art = misArticulos.buscaArticulo(cod);
                    do {
                    ...
                    alq = new Alquiler(art, dias, cli);
                    if (misAlquileres.buscaAlquileres(cod, cli.getCodSocio()) == null) {
                        ok = misAlquileres.anadirAlquiler(alq);
                        if (ok) {
                            System.out.println("Alquiler añadido !!!");
                        } else {
                            System.out.println("No se ha podido añadir el alquiler");
                        }
                    } else {
                        System.out.println("Este alquiler ya existe");
                    }
                    break;
                case 7:
                    ok = false;
                    ...
                    art = misArticulos.buscaArticulo(cod);
                    if (misAlquileres.buscaAlquileres(cod, cli.getCodSocio()) != null) {
                        ok = misAlquileres.borrarAlquiler(cod, cli.getCodSocio());
                        if (ok) {
                            System.out.println("Articulo devuelto !!!");
                        } else {
                            System.out.println("No se ha podido devolver el articulo");
                        }
                    } else {
                        System.out.println("Este articulo no se a alquilado");
                    }
                    break;
                case 8:
